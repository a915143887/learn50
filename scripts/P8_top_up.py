...
class top_up(CheckPoint):
    ...
    #充值
    @parameterized.expand(build_data(filename="P8_top_up.json", params_name="keywords, paymentType, amount, formStr, valicode, top_up_status_code, top_up_status, description, third_status_code, third_text"))
    def test001_and_002_top_up(self, keywords, paymentType, amount, formStr, valicode, top_up_status_code, top_up_status, description, third_status_code, third_text):
        #登录
        headers_data = {
        ...
        response = self.top_up_api.login(self.session, headers_data, login_data)
